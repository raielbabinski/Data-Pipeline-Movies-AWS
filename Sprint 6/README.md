...
![Arquivos no s3 1](./Exercicios/glue_lab/arquivos_s3_1.png)

![Arquivos no s3 2](./Exercicios/glue_lab/arquivos_s3_2.png)

- **Logs do Job no Glue**

![Logs do job 1](./Exercicios/glue_lab/logs_1.png)

![Logs do job 2](./Exercicios/glue_lab/logs_2.png)

- **Tabelas Geradas Automaticamente pelo Crawler**

![Tabela Crawler](./Exercicios/glue_lab/tabela_crawler.png)
...
![Fundamentals of Analytics 2](./Certificados/Fundamentals_of_Analytics_2.png)

---

![AWS Glue Getting Started](./Certificados/AWS_Glue.png)
